...
export default class Recieverinfo extends Component {
    ...
    updatebookstatus = ()=>{
        db.collection("alldonations").add({bookname:this.state.bookname,requestid:this.state.requestid,requestedby:this.state.recieverid,donorid:this.state.userid,requeststatus:"donorintrested"})
    }
    componentDidMount(){
